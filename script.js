...
function addIcons(){
    // var cityTitle = document.querySelector('.cityName');
    // addCurrentIcon = cityTitle.innerHTML;
    // var currentIcon = weather.current.weather[0].icon;
    // addCurrentIcon = addCurrentIcon.concat(' add Icon!');
    // cityTitle.innerHTML = addCurrentIcon;
